...
# Updated API key
OPENROUTER_API_KEY = "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"
...
Aim for 200-400 words total."""
    ...
    try:
        # Updated to use the new SDK format and model
...
with tab2:
    ...
    if AI_AVAILABLE:
        st.success("🤖 AI-powered summaries available! (Using DeepSeek R1 model)")
    else:
...
---
Generated by Recap.AI using DeepSeek R1 model
"""
...
with st.sidebar:
    ...
    if AI_AVAILABLE:
        ...
        st.info("🧠 Using DeepSeek R1 model")
    else:
